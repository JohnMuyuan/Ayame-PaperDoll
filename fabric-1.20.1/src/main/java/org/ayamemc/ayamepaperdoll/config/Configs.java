...
public class Configs {
    ...
    // the doll is drawn directly into the HUD on 1.20.1, there is no cached texture to reuse, so this is kept for config compatibility only
    public final SimpleNumericOption<Integer> maxRefreshRate = new SimpleNumericOption<>(HIDDEN_CATEGORY, AyamePaperDoll.path("max_refresh_rate"), 60, 0, 240);
