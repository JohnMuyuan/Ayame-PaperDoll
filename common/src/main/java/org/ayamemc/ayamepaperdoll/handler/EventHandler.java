...
public class EventHandler {
    ...
    public static void renderPaperDoll(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        renderPaperDollForPriority(graphics, deltaTracker, DisplayPriority.DEFAULT);
    }

    @SuppressWarnings("DataFlowIssue")
    public static void renderPaperDollForPriority(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker, DisplayPriority priority) {
        if (CONFIGS.displayPriority.getValue() != priority) return;
    ...
    public static void renderHighestPriorityPaperDoll(GuiGraphicsExtractor graphics, float partialTick) {
        ...
        if (
            ...
            paperDollRenderer.extractPaperdoll(graphics, partialTick);
        }
    }
